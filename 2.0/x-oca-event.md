...
Certain events are important for security context which have their unique properties. The `x-oca-event` supports the following optional properties that should be populated only in certain `action` types.
